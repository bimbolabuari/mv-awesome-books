var luxon = (function (exports) {
  ...
  const todayDate = document.querySelector('#date-time');
  const todayTime = luxon.DateTime.now();
  todayDate.innerHTML += todayTime.toLocaleString(luxon.DateTime.DATETIME_MED);